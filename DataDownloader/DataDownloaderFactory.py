...
class DataDownloaderFactory:
    ...
    def download_data(data_type, start_date, end_date):
        ...
        if data_type in data.data_sources.keys():
            ...
            downloader = YahooDataDownloader(data_type=symbol, start_date=start_date, end_date=end_date)
...
if __name__ == "__main__":
    try:
        data = DataDownloaderFactory.download_data("Apple", '2018-01-01', '2023-01-01')
        print(data)
